...
This Discord bot is operated as part of the Pizza & Friends community. This policy describes how the bot handles information when you interact with it on Discord.
...
Open an issue in this repository or reach the community via [joinpizza.fun](https://joinpizza.fun).
